...
class CommentModelTestCase(TimeStampedModelTestMixin, TestCase):
    ...
    def test_parent_related_name(self):
        """Tests that the parent field has the related name 'replies'."""
        self.assertEqual(
    ...
    def test_post_foreign_key(self):
        """Tests that the post field is a ForeignKey."""
        self._test_field_class_name("post", "ForeignKey")

    def test_post_related_name(self):
        """Tests that the post field has the related name 'comments'."""
        self.assertEqual(
    ...
    def test_post_on_delete(self):
        """Tests that the post field has the CASCADE on_delete option."""
        self.assertEqual(
    ...
    def test_author_foreign_key(self):
        """Tests that the author field is a ForeignKey."""
        self._test_field_class_name("author", "ForeignKey")

    def test_author_related_name(self):
        """Tests that the author field has the related name 'comments'."""
        self.assertEqual(
    ...
    def test_author_on_delete(self):
        """Tests that the author field has the CASCADE on_delete option."""
        self.assertEqual(
    ...
    def test_string_representation(self):
        """Tests that the string representation is the author and post."""
    ...
    def test_ordering(self):
        """Tests that the default ordering is by created_at and updated_at descending."""
        self.assertEqual(
